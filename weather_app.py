...
class WeatherApp(QWidget):
    ...
    def get_weather(self):
        ...
        if not api_key:
            self.display_error("Missing API key. Set OPENWEATHER_API_KEY")
            return
        ...
        try:
            ...
            self.display_error("Connection error occurred. Check your internet connection")
    ...
    def display_weather(self, data):
        ...
        self.temperature_label.setText(f"{temperature_fahrenheit:.2f}°F")
